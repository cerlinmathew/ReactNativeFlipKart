...
const ProductScreen = () => {
    ...
    return (
        <ScrollView style={styles.container}>
            ...
            <Text style={styles.tagline}>Price and other details vary based on product size and color</Text>
            {ProductData.map(item => (
                <View key={item.id} style={styles.productSection}>
                    ...
                    <View style={styles.productDetailSection}>
                        ...
                        <Image source={require('../assets/primelogo.png')} style={styles.logo} />
